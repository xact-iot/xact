...
export interface VisualScript {
  ...
  runtimeState?: string; outOfDate: boolean;
}
...
export interface NodeDefinition { type: string; typeVersion: number; name: string; description: string; category: string; icon: string; inputs: PortDefinition[]; outputs: PortDefinition[]; parameters: ParameterDefinition[]; available: boolean; unavailableReason?: string }
