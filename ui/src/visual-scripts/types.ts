...
export interface NodeDefinition { type: string; typeVersion: number; name: string; description: string; category: string; icon: string; inputs: PortDefinition[]; outputs: PortDefinition[]; parameters: ParameterDefinition[]; parameterSchema?: Record<string, any>; editorModule?: string; pluginName?: string; pluginVersion?: string; pluginHash?: string; available: boolean; unavailableReason?: string; outputNode?: boolean; simulationSafe?: boolean }
