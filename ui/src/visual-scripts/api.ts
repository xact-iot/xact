...
export const getRuns = (id: string) => apiRequest<VisualScriptRun[]>(`${root}/${encodeURIComponent(id)}/runs?limit=200`);
...
export const clearRuns = (id: string) => apiRequest<void>(`${root}/${encodeURIComponent(id)}/runs`, { method: 'DELETE' });
