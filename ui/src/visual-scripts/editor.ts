...
export class VisualScriptEditor extends HTMLElement {
  ...
  private render(): void {
    ...
    this.innerHTML = `
      <style>
        visual-script-editor{--vs-toolbar-font-size:13px;--vs-toolbar-meta-font-size:12px;--vs-toolbar-control-height:30px;position:fixed;inset:58px 18px 18px 252px;z-index:3100;display:grid;grid-template-rows:auto minmax(0,1fr) minmax(130px,22%);background:var(--content-bg);border:1px solid var(--border-color);border-radius:8px;box-shadow:0 18px 60px rgba(0,0,0,.45);overflow:hidden;color:var(--content-text);font-family:var(--widget-font-family)}
        visual-script-editor .vse-toolbar{display:flex;flex-wrap:wrap;align-items:center;gap:6px;min-height:43px;box-sizing:border-box;padding:6px 9px;border-bottom:1px solid var(--border-color);background:var(--widget-bg);font-size:var(--vs-toolbar-font-size);line-height:18px}
        ...
        visual-script-editor .vse-toolbar>button,visual-script-editor .vse-menu>summary{min-height:var(--vs-toolbar-control-height);box-sizing:border-box;padding:5px 9px;font-size:var(--vs-toolbar-font-size);font-weight:500;line-height:18px}visual-script-editor .vse-title{min-width:110px;font-size:var(--vs-toolbar-font-size);font-weight:700}.vse-current{font-size:var(--vs-toolbar-meta-font-size);opacity:.72;margin-right:auto}.vse-badge{padding:2px 7px;border-radius:10px;background:color-mix(in srgb,var(--accent-color) 18%,transparent);font-size:var(--vs-toolbar-meta-font-size);line-height:16px;text-transform:capitalize}
        visual-script-editor .vse-menu{position:relative}.vse-menu>summary{list-style:none;cursor:pointer;border:1px solid var(--border-color);border-radius:4px}.vse-menu>summary::-webkit-details-marker{display:none}.vse-menu-panel{position:absolute;right:0;top:calc(100% + 5px);z-index:5;min-width:190px;padding:6px;background:var(--modal-bg,var(--widget-bg));border:1px solid var(--border-color);border-radius:6px;box-shadow:0 10px 30px rgba(0,0,0,.35)}.vse-menu-panel button,.vse-menu-panel label{box-sizing:border-box;display:flex;width:100%;align-items:center;gap:8px;padding:7px 8px;font-size:13px}.vse-menu-panel button{border:0;text-align:left}.vse-menu-panel input{margin-left:auto;width:auto}
