...
func coreDefinitions() []NodeDefinition {
	...
	return []NodeDefinition{
		...
		{Type: "core.get-context", TypeVersion: 1, Name: "Get Context", Description: "Reads ephemeral node or script context", Category: "Context", Icon: "⇥", Inputs: in, Outputs: out, Parameters: contextParameters(false), Available: true},
