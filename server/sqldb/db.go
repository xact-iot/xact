...
const (
	...
	StarterAutomationName           = "Automation"
	...
	StarterAutomationWidgetsJSON    = `[{"id":"visual-script","type":"visual-script-widget","x":0,"y":0,"w":24,"h":28,"config":{"scriptId":"","display":"editor","showRuntimeStatus":true}}]`
